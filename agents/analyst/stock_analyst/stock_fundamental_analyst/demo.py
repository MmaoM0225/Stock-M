...
Stock Fundamental Analyst Demo。
    ...
    python -m agents.analyst.stock_analyst.stock_fundamental_analyst.demo 000001
    python -m agents.analyst.stock_analyst.stock_fundamental_analyst.demo 600519 20260401
"""
